...
public final class ResultViewTrackModel extends TrackingMapModel {
    ...
    public ResultViewTrackModel(@NonNull final PaymentCongratsModel paymentCongratsModel,
        @NonNull final String currencyId, final boolean isMP) {
        this(Style.CUSTOM,
            paymentCongratsModel.getPaymentId(),
            paymentCongratsModel.getCongratsType().name(),
            paymentCongratsModel.getPaymentStatusDetail(),
            PaymentDataHelper.isSplitPayment(paymentCongratsModel.getPaymentsInfo()),
            paymentCongratsModel.getTotalAmount(),
            null,//TODO ESTA BIEN MANDAR NULL SI UN CAMPO NO ES REQUERIDO?
            paymentCongratsModel.getPaymentCongratsResponse().getScore() != null ? paymentCongratsModel
                .getPaymentCongratsResponse().getScore()
                .getProgress().getLevel() : null,
            ...
            paymentCongratsModel.getCampaignId(),
        ...
        hasMoneySplitView = isMP && paymentCongratsModel.getPaymentCongratsResponse().getMoneySplit() != null;
    }
    ...
    private ResultViewTrackModel(@NonNull final Style style, @Nullable final Long paymentId, final String paymentStatus,
        ...
        /*if (paymentData != null) { //TODO NO TENEMOS PAYMENTDATA
